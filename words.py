wordlist = {
    'scrum master': 'A facilitator in an agile development team',
    ...
    'if statement': 'A logical block which will execute the following code if a given condition is true',
    'else statement': 'A statement which describes what to do if a given condition is not true',
    'while loop': 'A block of code which will run itself repeatedly until a condition is met',
